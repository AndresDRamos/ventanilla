...
const TicketCard = ({
  ...
  // Función para formatear fecha corta (dd/mm/aa)
    ...
    <Card>
      ...
      <Content onClick={(e) => e.stopPropagation()}>
        <InfoRow>
          ...
          <InfoValue>{ticket.empleado} (#{ticket.codigoEmpleado})</InfoValue>
        </InfoRow>
        ...
        <InfoRow>
          ...
          <InfoValue>{getResponsable(ticket.idPlanta, ticket.idTipoSolicitud)}</InfoValue>
        </InfoRow>
      </Content>
    </Card>
  );
